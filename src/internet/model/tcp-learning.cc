...
{
  static TypeId tid =
      TypeId ("ns3::TcpLearning")
          .SetParent<TcpNewReno> ()
          .AddConstructor<TcpLearning> ()
          .SetGroupName ("Internet")
          .AddAttribute ("AlphaMin", "Minimum alpha threshold", DoubleValue (0.3),
                         MakeDoubleAccessor (&TcpLearning::m_alphaMin),
                         MakeDoubleChecker<double> ())
          .AddAttribute ("AlphaMax", "Maximum alpha threshold", DoubleValue (10.0),
                         MakeDoubleAccessor (&TcpLearning::m_alphaMax),
                         MakeDoubleChecker<double> ())
          .AddAttribute ("AlphaBase", "Alpha base threshold", DoubleValue (1.0),
                         MakeDoubleAccessor (&TcpLearning::m_alphaBase),
                         MakeDoubleChecker<double> ())
          .AddAttribute ("BetaMin", "Minimum beta threshold", DoubleValue (0.125),
                         MakeDoubleAccessor (&TcpLearning::m_betaMin), MakeDoubleChecker<double> ())
          .AddAttribute ("BetaMax", "Maximum beta threshold", DoubleValue (0.5),
                         MakeDoubleAccessor (&TcpLearning::m_betaMax), MakeDoubleChecker<double> ())
          .AddAttribute ("BetaBase", "Beta base threshold", DoubleValue (0.5),
                         MakeDoubleAccessor (&TcpLearning::m_betaBase),
                         MakeDoubleChecker<double> ())
          .AddAttribute ("WinThresh", "Window threshold", UintegerValue (15),
                         MakeUintegerAccessor (&TcpLearning::m_winThresh),
                         MakeUintegerChecker<uint32_t> ())
          .AddAttribute ("Theta", "Theta threshold", UintegerValue (5),
                         MakeUintegerAccessor (&TcpLearning::m_theta),
                         MakeUintegerChecker<uint32_t> ());
  return tid;
}
...
void
TcpLearning::RecalcParam (uint32_t cWnd)
{
...
void
TcpLearning::CongestionStateSet (Ptr<TcpSocketState> tcb,
...
uint32_t
TcpLearning::GetSsThresh (Ptr<const TcpSocketState> tcb, uint32_t bytesInFlight)
{
...
void
TcpLearning::CalculateAlpha (double da, double dm)
{
...
void
TcpLearning::CalculateBeta (double da, double dm)
{
  NS_LOG_FUNCTION (this << da << dm);
...
Time
TcpLearning::CalculateAvgDelay () const
{
  NS_LOG_FUNCTION (this);
...
Time
TcpLearning::CalculateMaxDelay () const
{
  NS_LOG_FUNCTION (this);
...
void
TcpLearning::Reset (const SequenceNumber32 &nextTxSequence)
{
